# Demonstration of building OCFL v1.1 specification examples
...
fsw_openfs(fixtures/1.1/content/spec-ex-minimal, create=False, exists_ok=True)
### Inventory for v1
{
...
fsw_openfs(fixtures/1.1/content/spec-ex-full, create=False, exists_ok=True)
fsw_openfs(fixtures/1.1/content/spec-ex-full/v1, create=False, exists_ok=True)
fsw_openfs(fixtures/1.1/content/spec-ex-full/v2, create=False, exists_ok=True)
fsw_openfs(fixtures/1.1/content/spec-ex-full/v3, create=False, exists_ok=True)
### Inventory for v3
{
  "digestAlgorithm": "sha512-spec-ex",
  "fixity": {
...
fsw_openfs(fixtures/1.1/content/spec-ex-diff-paths/v1, create=False, exists_ok=True)
### Inventory for v1
{
  "digestAlgorithm": "sha512-spec-ex",
  "head": "v1",
