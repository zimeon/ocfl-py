...
| E033 | **Not in specification** | OCFL Object %s inventory is not valid JSON (%s) \[[ocfl/object.py#L544](https://github.com/zimeon/ocfl-py/blob/main/ocfl/object.py#L544) [ocfl/validator.py#L155](https://github.com/zimeon/ocfl-py/blob/main/ocfl/validator.py#L155)\] |
...
| | E092a | OCFL Object %s inventory manifest using digest algorithm %s has digest %s for file %s which doesn't match calculated digest %s for that file \[[ocfl/validator.py#L390](https://github.com/zimeon/ocfl-py/blob/main/ocfl/validator.py#L390) [ocfl/validator.py#L385](https://github.com/zimeon/ocfl-py/blob/main/ocfl/validator.py#L385)\] |
...
| | E093a | OCFL Object %s inventory fixity block for digest algorithm %s has digest %s for file %s which doesn't match calculated digest %s for that file \[[ocfl/validator.py#L391](https://github.com/zimeon/ocfl-py/blob/main/ocfl/validator.py#L391) [ocfl/validator.py#L388](https://github.com/zimeon/ocfl-py/blob/main/ocfl/validator.py#L388)\] |
...
_Generated by `extract_codes.py` at 2022-07-19 16:15:14.276681_