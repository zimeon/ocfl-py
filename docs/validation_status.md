...
| E033 | **Not in specification** | OCFL Object %s inventory is not valid JSON (%s) \[[ocfl/validator.py#L155](https://github.com/zimeon/ocfl-py/blob/main/ocfl/validator.py#L155) [ocfl/object.py#L542](https://github.com/zimeon/ocfl-py/blob/main/ocfl/object.py#L542)\] |
...
_Generated by `extract_codes.py` at 2022-07-19 16:39:42.054120_