...
| | E001a | OCFL Object root contains unexpected file: %s \[[ocfl/validator.py#L155](https://github.com/zimeon/ocfl-py/blob/main/ocfl/validator.py#L155)\] |
| | E001b | OCFL Object root contains unexpected directory: %s \[[ocfl/validator.py#L162](https://github.com/zimeon/ocfl-py/blob/main/ocfl/validator.py#L162)\] |
| | E001c | OCFL Object root contains unexpected entry that isn't a file or directory: %s \[[ocfl/validator.py#L164](https://github.com/zimeon/ocfl-py/blob/main/ocfl/validator.py#L164)\] |
...
| | E003a | OCFL Object version declaration file is missing \[[ocfl/validator.py#L66](https://github.com/zimeon/ocfl-py/blob/main/ocfl/validator.py#L66)\] |
| | E003b | OCFL Object includes more that one file that looks like an object declaration (got %s) \[[ocfl/validator.py#L68](https://github.com/zimeon/ocfl-py/blob/main/ocfl/validator.py#L68)\] |
| | E003c | No OCFL Object to validate at path %s. The root of an OCFL Object must be a directory containing an object declaration \[[ocfl/validator.py#L61](https://github.com/zimeon/ocfl-py/blob/main/ocfl/validator.py#L61)\] |
| E007 | **Not in specification** | OCFL Object declaration file contents do not match file name without leading 0= (the 'dvalue') \[[ocfl/validator.py#L70](https://github.com/zimeon/ocfl-py/blob/main/ocfl/validator.py#L70)\] |
...
| E015 | **Not in specification** | OCFL Object version directory %s includes an illegal file (%s) \[[ocfl/validator.py#L253](https://github.com/zimeon/ocfl-py/blob/main/ocfl/validator.py#L253)\] |
...
| | E023a | OCFL Object %s inventory manifest refers to a file path that is not present in the object (%s) \[[ocfl/validator.py#L259](https://github.com/zimeon/ocfl-py/blob/main/ocfl/validator.py#L259)\] |
| | E023b | OCFL Object includes one or more files that are not mentioned in the %s inventory manifest (%s) \[[ocfl/validator.py#L277](https://github.com/zimeon/ocfl-py/blob/main/ocfl/validator.py#L277)\] |
| E024 | **Not in specification** | OCFL Object version %s content directory includes empty path %s \[[ocfl/validator.py#L243](https://github.com/zimeon/ocfl-py/blob/main/ocfl/validator.py#L243)\] |
...
| E033 | **Not in specification** | OCFL Object %s inventory is not valid JSON (%s) \[[ocfl/validator.py#L107](https://github.com/zimeon/ocfl-py/blob/main/ocfl/validator.py#L107)\] |
| E034 | **Not in specification** | OCFL Object root inventory is missing \[[ocfl/validator.py#L74](https://github.com/zimeon/ocfl-py/blob/main/ocfl/validator.py#L74)\] |
...
| | E058a | OCFL Object %s inventory is missing sidecar digest file at %s \[[ocfl/validator.py#L118](https://github.com/zimeon/ocfl-py/blob/main/ocfl/validator.py#L118)\] |
| | E058b | Cannot extract digest type from inventory digest file name %s \[[ocfl/validator.py#L141](https://github.com/zimeon/ocfl-py/blob/main/ocfl/validator.py#L141)\] |
| E060 | **Not in specification** | Mismatch between actual and recorded inventory digests for %s (calcuated %s but read %s from %s) \[[ocfl/validator.py#L137](https://github.com/zimeon/ocfl-py/blob/main/ocfl/validator.py#L137)\] |
| E061 | **Not in specification** | Cannot extract digest from inventory digest file (%s) \[[ocfl/validator.py#L139](https://github.com/zimeon/ocfl-py/blob/main/ocfl/validator.py#L139)\] |
| E064 | **Not in specification** | Object root inventory and copy in last version MUST be identical but are not (%s and %s) \[[ocfl/validator.py#L205](https://github.com/zimeon/ocfl-py/blob/main/ocfl/validator.py#L205)\] |
...
| E067 | **Not in specification** | OCFL Object extensions direct contains an unexpected non-directory entry: %s \[[ocfl/validator.py#L182](https://github.com/zimeon/ocfl-py/blob/main/ocfl/validator.py#L182)\] |
...
| E092 | **Not in specification** | OCFL Object %s inventory manifest has digest %s for file %s which doesn't match calculated digest %s for that file \[[ocfl/validator.py#L264](https://github.com/zimeon/ocfl-py/blob/main/ocfl/validator.py#L264) [ocfl/inventory_validator.py#L132](https://github.com/zimeon/ocfl-py/blob/main/ocfl/inventory_validator.py#L132)\] |
| E093 | **Not in specification** | OCFL Object %s inventory fixity block for digest algorithm %s has digest %s for file %s which doesn't match calculated digest %s for that file \[[ocfl/validator.py#L274](https://github.com/zimeon/ocfl-py/blob/main/ocfl/validator.py#L274)\] |
...
| E301 | **Not in specification** | **Missing description** \[[ocfl/validator.py#L230](https://github.com/zimeon/ocfl-py/blob/main/ocfl/validator.py#L230)\] |
...
| W002 | **Not in specification** | OCFL Object version directory %s SHOULD NOT contain any directory except the designated content directory (found %s) \[[ocfl/validator.py#L251](https://github.com/zimeon/ocfl-py/blob/main/ocfl/validator.py#L251)\] |
| W003 | **Not in specification** | OCFL Object version directory %s SHOULD NOT contain an empty content directory \[[ocfl/validator.py#L249](https://github.com/zimeon/ocfl-py/blob/main/ocfl/validator.py#L249)\] |
...
| W010 | **Not in specification** | OCFL Object %s SHOULD have an inventory file but does not \[[ocfl/validator.py#L194](https://github.com/zimeon/ocfl-py/blob/main/ocfl/validator.py#L194)\] |
...
| W013 | **Not in specification** | OCFL Object includes unregistered extension directory '%s' \[[ocfl/validator.py#L180](https://github.com/zimeon/ocfl-py/blob/main/ocfl/validator.py#L180)\] |

_Generated by `extract_codes.py` at 2020-07-10 09:21:25.878143_